        ...
        if let user = Auth.auth().currentUser {
            FirestoreServices.shared.getUserData(user: user) { (result) in
                ...
                case .success(let muser):
                    let mainTabBar = storyboard.instantiateViewController(withIdentifier: "MainTabBarViewController") as! MainTabBarViewController
                ...
                case .failure(_):
                    ...
                    self.window?.rootViewController = createProfileVC
                }
            }
        } else {
            let authVC = storyboard.instantiateViewController(withIdentifier: "AuthVC") as! AuthNC

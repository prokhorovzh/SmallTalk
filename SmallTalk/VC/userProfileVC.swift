...
class userProfileVC: UIViewController {
    ...
    @objc private func sendMessage() {
        ...
        self.dismiss(animated: true) {
            FirestoreServices.shared.createChat(message: message, receider: self.user) { (result) in
                switch result {
                    
                case .success():
                    UIApplication.getTopViewController()?.showAlert(with: "Success", and: "Your message was sent")

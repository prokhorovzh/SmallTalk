...
//  SmallTalk
//
//  Created by Евгений Прохоров on 23.06.2020.
        ...
        StorageService.shared.uploadImageMessage(photo: image, to: chat) { (result) in
            ...
            case .success(let url):
                ...
                FirestoreServices.shared.sendMessage(chat: self.chat, message: message) { (result) in
                    ...
                    case .failure(_):
                        self.showAlert(with: "Error", and: "Сообщение не было доставлено")
                    }
                }
            case .failure(let error):
...
extension ChatsViewController {
    func configureMessageInputBar() {
        ...
        messageInputBar.inputTextView.textContainerInset = UIEdgeInsets(top: 14, left: 10, bottom: 14, right: 10)
        messageInputBar.inputTextView.placeholderLabelInsets = UIEdgeInsets(top: 14, left: 15, bottom: 14, right: 15)
    ...
    func configureCameraIcon() {
        ...
        cameraItem.tintColor = #colorLiteral(red: 0.03921568627, green: 0.5176470588, blue: 1, alpha: 1)
...
extension ChatsViewController: MessagesDisplayDelegate {
    ...
    func backgroundColor(for message: MessageType, at indexPath: IndexPath, in messagesCollectionView: MessagesCollectionView) -> UIColor {
        return isFromCurrentSender(message: message) ?  #colorLiteral(red: 0.03921568627, green: 0.5176470588, blue: 1, alpha: 1) : #colorLiteral(red: 0.9019607843, green: 0.9019607843, blue: 0.9019607843, alpha: 1)
    }
    
    func textColor(for message: MessageType, at indexPath: IndexPath, in messagesCollectionView: MessagesCollectionView) -> UIColor {
        return isFromCurrentSender(message: message) ? .white : #colorLiteral(red: 0.3019607843, green: 0.3019607843, blue: 0.3019607843, alpha: 1)
    }
    //
